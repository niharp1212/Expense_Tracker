    ...
    public class ExpenseController : Controller
    {
        ...
        public ActionResult AddTotallimit(Total_expenseLimit model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["msg"] = "Total Limit Added";
                dbobj.SaveChanges();
        ...
        public ActionResult AddExpense(ExpenseData e)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["msg"] = "New Expense Added";
                dbobj.SaveChanges();
        ...
        public ActionResult ExpenseEdit(int id) {
            var cname = dbobj.ExpenseDatas.Find(id);
            var clist = dbobj.Categories.ToList();
            ViewBag.CategoryId = new SelectList(clist, "CategoryId", "CategoryName",cname.CategoryId);
